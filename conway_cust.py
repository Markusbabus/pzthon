...
while True:
    print('Milyen széles területet akarsz?(min. 3)')
    WIDTH = int((input()))

    if WIDTH <= 3:
        print('Nagyobnak kell lennie mint 3')
        continue
...
while True:
    print('Milyen magas területet akarsz?(min. 3)')
    HEIGHT = int((input()))
...
while True:
    print('Mennyi élő cellát szeretnél?(1/x)')
    chance = int((input()))

    if chance < 1:
        print('Legalább egynek  kell lennie.')
        continue
